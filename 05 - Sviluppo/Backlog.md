...
| 52 | **Il raggio d'ingaggio è misurato centro-a-centro e non tiene conto della taglia del bersaglio.** Con l'Invasore a 1.5 e il Cuore che è un cubo 2×2, il margine è di pochi decimetri: appena il Cuore diventerà davvero 6×6 (footprint dichiarato) gli attacchi torneranno a non partire, per lo stesso motivo della regressione del 2026-07-28. Serve sottrarre il raggio del bersaglio, o mirare alla sua superficie invece che al centro. **Da fare prima di ingrandire gli edifici** | [[Combattimento Base]] · [[Costruzione su Griglia]] |
